...
export const workoutTemplates: WorkoutTemplate[] = [
  {
    ...
    exercises: [
      ...
      { id: 'pa_leg_extension', name: 'Leg extension', targetSets: 3, targetReps: '10-15', supersetGroup: 'SS2', supersetPosition: 'b', equipmentType: 'machine' },
      { id: 'pa_straight_bar_pushdown', name: 'Straight bar pushdown / skull crusher', targetSets: 2, targetReps: '10-12', supersetGroup: 'SS3', supersetPosition: 'a', equipmentType: 'cable' },
      ...
      { id: 'pa_rope_pushdown', name: 'Single-arm rope pushdown', targetSets: 3, targetReps: '10-12', supersetGroup: 'SS4', supersetPosition: 'b', equipmentType: 'cable' },
    ],
  },
  {
    id: 'push_b',
    ...
    exercises: [
      ...
      { id: 'pb_goblet_squat', name: 'Goblet squat', targetSets: 3, targetReps: '10-12', supersetGroup: 'SS2', supersetPosition: 'b', equipmentType: 'dumbbell' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'pla_swiss_ball_leg_curl', name: 'Swiss ball hamstring curl', targetSets: 3, targetReps: '10-15', supersetGroup: 'SS1', supersetPosition: 'b', equipmentType: 'bodyweight', isBodyweight: true },
      ...
      { id: 'pla_pallof_press', name: 'Pallof press', targetSets: 3, targetReps: '10-12/side', supersetGroup: null, supersetPosition: null, equipmentType: 'cable' },
    ],
  },
  {
    id: 'pull_b',
    ...
    exercises: [
      ...
      { id: 'plb_hanging_leg_raise', name: 'Hanging leg raise', targetSets: 3, targetReps: '12-15', supersetGroup: 'SS2', supersetPosition: 'b', equipmentType: 'bodyweight', isBodyweight: true },
      ...
      { id: 'plb_cable_crunch', name: 'Cable crunch / weighted sit-up', targetSets: 3, targetReps: '12-15', supersetGroup: 'SS3', supersetPosition: 'b', equipmentType: 'cable' },
      ...
      { id: 'plb_hammer_curl', name: 'Hammer curl', targetSets: 3, targetReps: '10-12', supersetGroup: null, supersetPosition: null, equipmentType: 'dumbbell' },
    ],
  },
]
