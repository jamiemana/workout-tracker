...
export const workoutTemplates: WorkoutTemplate[] = [
  {
    ...
    exercises: [
      ...
      { id: 'pa_standing_calf_raise', name: 'Standing calf raise', targetSets: 3, targetReps: '10-15', supersetGroup: 'SS2', supersetPosition: 'b', equipmentType: 'machine' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'pb_seated_calf_raise', name: 'Seated calf raise', targetSets: 3, targetReps: '10-15', supersetGroup: 'SS2', supersetPosition: 'b', equipmentType: 'machine' },
