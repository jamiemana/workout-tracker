...
header = "// Generated by design/muscle-map/build.py. Edit the geometry there, not here.\n"
open(app_ts, "w").write(header + "export const BODY_PATHS = " + json.dumps(ts, indent=2) + " as const\n")
print("wrote", os.path.relpath(app_ts, HERE))
